  ...
  return (
    <header className="w-full h-28 grid grid-rows-[50%_50%] border-red border-2">
      <div
        class Name={` ${
          features
            ? " shadow-md shadow-black-200 duration-700"
            : "hover:shadow-md shadow-black duration-700"
        } z-10 w-full grid  grid-cols-[60%_40%] col-span-full bg-white   fixed`}
      >
        {/* navbar */}
        <nav className="">
          <ul className=" col-start-1 col-end-2   h-14 flex flex-wrap items-center justify-start list-none text-base gap-10 ">
            ...
            <li className="relative left-20">
              <NavLink
                className={`${
                  features
                    ? "text-blue-700 border-blue-700 border-b-2 transition- duration-1000 "
                    : "text-black"
                }h-14 flex flex-wrap items-center justify-center `}
                to="#"
                onClick={() => {
            ...
            <li className="relative left-20 hover:text-blue-500">
              ...
              }  flex justify-center  hover:text-blue-500`}
                onClick={() => {
        ...
        <div className="col-start-2 flex flex-wrap justify-end items-center text-xl">
          <Link to="/login" className=" block relative right-36">
            Log in
          </Link>
          <Link to="#">
            <button
              style={{ backgroundColor: "rgb(0 128 255)" }}
              className="text-white h-14 w-44 relative right-32 "
            >
              Get Trello for free
            </button>
          </Link>
      ...
      {/* header statment  */}
      <div
        style={{ backgroundColor: "rgb(222, 235, 255)" }}
        className="row-start-2 flex flex-wrap justify-center items-center"
      >
        <p>
